 ...
 */
exports.mapPaths = mapping.mapPaths;

/**
 * Maps specific directory (for use with `mock()`)
 */
exports.mapDir = mapping.mapDir;

/**
 * Maps specific file (for use with `mock()`)
 */
exports.mapFile = mapping.mapFile;
 ...
 */
exports.disable = bypass.disable;

/**
 * Enables Mocked FS after being disabled by mock.disable()
 */
exports.enable = bypass.enable;
